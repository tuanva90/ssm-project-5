        ...
        <asp:MultiView ID="MultiView2" runat="server">
            <asp:View ID="View2" runat="server">
                ...
                <asp:DetailsView ID="dths" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                    Height="50px" Style="text-align: center" Width="700px">
                    ...
                    <Fields>
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                &nbsp;&nbsp;
                                <asp:LinkButton ID="lbtnDelete" runat="server" OnClick="lbtnDelete_Click" OnClientClick="return confirm(&quot;Are you sure Delete?&quot;);">Delete</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Fields>
